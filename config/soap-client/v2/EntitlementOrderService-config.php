...
return Config::create()
    ...
    ->setClientDestination('src/Services/v2/EntitlementOrderService')
    ->setClientName('EntitlementOrderServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\v2\EntitlementOrderService')
    ->setClassMapDestination('src/Services/v2/EntitlementOrderService')
    ->setClassMapName('EntitlementOrderServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\v2\EntitlementOrderService')
