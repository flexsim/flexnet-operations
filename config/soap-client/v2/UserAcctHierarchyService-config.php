...
return Config::create()
    ->setEngine($engine = ExtSoapEngineFactory::fromOptions(
        ExtSoapOptions::defaults('wsdls/v2/UserAcctHierarchyService.wsdl', [])
            ->disableWsdlCache()
    ))
    ->setTypeDestination('src/Type/')
    ->setTypeNamespace('Flexsim\FlexnetOperations\Type')
    ->setClientDestination('src/Services/v2/UserAcctHierarchyService')
    ->setClientName('UserAcctHierarchyServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\v2\UserAcctHierarchyService')
    ->setClassMapDestination('src/Services/v2/UserAcctHierarchyService')
    ->setClassMapName('UserAcctHierarchyServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\v2\UserAcctHierarchyService')
