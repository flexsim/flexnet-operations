...
return Config::create()
    ->setEngine($engine = DefaultEngineFactory::create(
        ExtSoapOptions::defaults('wsdls/v1/FlexnetAuthentication.wsdl', [])
            ->disableWsdlCache()
    ))
    ->setTypeDestination('src/Type/')
    ->setTypeNamespace('Flexsim\FlexnetOperations\Type')
    ->setClientDestination('src/Services/FlexnetAuthentication/v1')
    ->setClientName('FlexnetAuthenticationClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\FlexnetAuthentication\v1')
    ->setClassMapDestination('src/Services/FlexnetAuthentication/v1')
    ->setClassMapName('FlexnetAuthenticationClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\FlexnetAuthentication\v1')
