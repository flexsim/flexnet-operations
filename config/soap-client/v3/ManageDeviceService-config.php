...
return Config::create()
    ...
    ->setClientDestination('src/Services/v3/ManageDeviceService')
    ->setClientName('ManageDeviceServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\v3\ManageDeviceService')
    ->setClassMapDestination('src/Services/v3/ManageDeviceService')
    ->setClassMapName('ManageDeviceServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\v3\ManageDeviceService')
