...
return Config::create()
    ...
    ->setClientDestination('src/Services/EntitlementOrderService/v3')
    ->setClientName('EntitlementOrderServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\EntitlementOrderService\v3')
    ->setClassMapDestination('src/Services/EntitlementOrderService/v3')
    ->setClassMapName('EntitlementOrderServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\EntitlementOrderService\v3')
