...
return Config::create()
    ->setEngine($engine = DefaultEngineFactory::create(
        ExtSoapOptions::defaults('wsdls/v3/UserAcctHierarchyService.wsdl', [])
            ->disableWsdlCache()
    ))
    ->setTypeDestination('src/Type/')
    ->setTypeNamespace('Flexsim\FlexnetOperations\Type')
    ->setClientDestination('src/Services/UserAcctHierarchyService/v3')
    ->setClientName('UserAcctHierarchyServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\UserAcctHierarchyService\v3')
    ->setClassMapDestination('src/Services/UserAcctHierarchyService/v3')
    ->setClassMapName('UserAcctHierarchyServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\UserAcctHierarchyService\v3')
