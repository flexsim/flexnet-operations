...
return Config::create()
    ->setEngine($engine = DefaultEngineFactory::create(
        ExtSoapOptions::defaults('wsdls/v2/ProductPackagingService.wsdl', [])
            ->disableWsdlCache()
    ))
    ->setTypeDestination('src/Type/')
    ->setTypeNamespace('Flexsim\FlexnetOperations\Type')
    ->setClientDestination('src/Services/ProductPackagingService/v2')
    ->setClientName('ProductPackagingServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\ProductPackagingService\v2')
    ->setClassMapDestination('src/Services/ProductPackagingService/v2')
    ->setClassMapName('ProductPackagingServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\ProductPackagingService\v2')
