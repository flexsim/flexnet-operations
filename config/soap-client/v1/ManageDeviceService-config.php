...
return Config::create()
    ...
    ->setClientDestination('src/Services/v1/ManageDeviceService')
    ->setClientName('ManageDeviceServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\v1\ManageDeviceService')
    ->setClassMapDestination('src/Services/v1/ManageDeviceService')
    ->setClassMapName('ManageDeviceServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\v1\ManageDeviceService')
