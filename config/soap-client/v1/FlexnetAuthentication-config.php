...
return Config::create()
    ...
    ->setClientDestination('src/Services/v1/FlexnetAuthentication')
    ->setClientName('FlexnetAuthenticationClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\v1\FlexnetAuthentication')
    ->setClassMapDestination('src/Services/v1/FlexnetAuthentication')
    ->setClassMapName('FlexnetAuthenticationClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\v1\FlexnetAuthentication')
