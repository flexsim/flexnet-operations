...
return Config::create()
    ->setEngine($engine = ExtSoapEngineFactory::fromOptions(
        ExtSoapOptions::defaults('wsdls/LicenseService.wsdl', [])
            ->disableWsdlCache()
    ))
    ->setTypeDestination('src/Type/')
    ->setTypeNamespace('Flexsim\FlexnetOperations\Type')
    ->setClientDestination('src/Services/LicenseService')
    ->setClientName('LicenseServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\LicenseService')
    ->setClassMapDestination('src/Services/LicenseService')
    ->setClassMapName('LicenseServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\LicenseService')
