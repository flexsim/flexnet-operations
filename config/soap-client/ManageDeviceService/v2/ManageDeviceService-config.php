...
return Config::create()
    ...
    ->setClientDestination('src/Services/ManageDeviceService/v2')
    ->setClientName('ManageDeviceServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\ManageDeviceService\v2')
    ->setClassMapDestination('src/Services/ManageDeviceService/v2')
    ->setClassMapName('ManageDeviceServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\ManageDeviceService\v2')
