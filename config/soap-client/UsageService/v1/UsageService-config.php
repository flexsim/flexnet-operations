...
return Config::create()
    ->setEngine($engine = DefaultEngineFactory::create(
        ExtSoapOptions::defaults('wsdls/v1/UsageService.wsdl', [])
            ->disableWsdlCache()
    ))
    ->setTypeDestination('src/Type/')
    ->setTypeNamespace('Flexsim\FlexnetOperations\Type')
    ->setClientDestination('src/Services/UsageService/v1')
    ->setClientName('UsageServiceClient')
    ->setClientNamespace('Flexsim\FlexnetOperations\Services\UsageService\v1')
    ->setClassMapDestination('src/Services/UsageService/v1')
    ->setClassMapName('UsageServiceClassmap')
    ->setClassMapNamespace('Flexsim\FlexnetOperations\Services\UsageService\v1')
