...
class RepairFulfillmentResponseDataType
{
    ...
    public function withFulfillment(?\Flexnet\LicenseService\Type\FulfillmentDataType $fulfillment): \Flexnet\LicenseService\Type\RepairFulfillmentResponseDataType
    {
        $new = clone $this;
