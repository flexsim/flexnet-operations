...
class RepairFulfillmentResponseDataType
{
     ...
     */
    public function withRecordRefNo(int $recordRefNo) : \Flexnet\LicenseService\Type\RepairFulfillmentResponseDataType
    {
        $new = clone $this;
     ...
     * @return RepairFulfillmentResponseDataType
     */
    public function withFulfillment(\Flexnet\LicenseService\Type\FulfillmentDataType|null $fulfillment) : \Flexnet\LicenseService\Type\RepairFulfillmentResponseDataType
    {
        $new = clone $this;
