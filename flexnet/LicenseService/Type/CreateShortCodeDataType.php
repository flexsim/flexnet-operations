...
class CreateShortCodeDataType
{
     ...
     */
    public function __construct(string|null $bulkEntitlementId = null, string $webRegkey, string $shortCode, \Flexnet\LicenseService\Type\PublisherAttributesListDataType|null $publisherAttributes = null, bool|null $overridePolicy = null, string|null $shortCodeActivationType = null, \Flexnet\LicenseService\Type\FulfillmentIdentifierType|null $reinstallFulfillment = null)
    {
     ...
     * @param \Flexnet\LicenseService\Type\FulfillmentIdentifierType|null $reinstallFulfillment
     */
    public static function create(string|null $bulkEntitlementId = null, string $webRegkey, string $shortCode, \Flexnet\LicenseService\Type\PublisherAttributesListDataType|null $publisherAttributes = null, bool|null $overridePolicy = null, string|null $shortCodeActivationType = null, \Flexnet\LicenseService\Type\FulfillmentIdentifierType|null $reinstallFulfillment = null)
    {
     ...
     */
    public function withBulkEntitlementId(string|null $bulkEntitlementId) : \Flexnet\LicenseService\Type\CreateShortCodeDataType
    {
        $new = clone $this;
     ...
     * @return CreateShortCodeDataType
     */
    public function withPublisherAttributes(\Flexnet\LicenseService\Type\PublisherAttributesListDataType|null $publisherAttributes) : \Flexnet\LicenseService\Type\CreateShortCodeDataType
    {
        $new = clone $this;
     ...
     * @return CreateShortCodeDataType
     */
    public function withOverridePolicy(bool|null $overridePolicy) : \Flexnet\LicenseService\Type\CreateShortCodeDataType
    {
        $new = clone $this;
     ...
     * @return CreateShortCodeDataType
     */
    public function withShortCodeActivationType(string|null $shortCodeActivationType) : \Flexnet\LicenseService\Type\CreateShortCodeDataType
    {
        $new = clone $this;
     ...
     */
    public function getReinstallFulfillment() : \Flexnet\LicenseService\Type\FulfillmentIdentifierType|null
    {
     ...
     * @return CreateShortCodeDataType
     */
    public function withReinstallFulfillment(\Flexnet\LicenseService\Type\FulfillmentIdentifierType|null $reinstallFulfillment) : \Flexnet\LicenseService\Type\CreateShortCodeDataType
    {
        $new = clone $this;
