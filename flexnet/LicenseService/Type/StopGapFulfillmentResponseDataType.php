...
class StopGapFulfillmentResponseDataType
{
    ...
    public function withFulfillment(?\Flexnet\LicenseService\Type\FulfillmentDataType $fulfillment): \Flexnet\LicenseService\Type\StopGapFulfillmentResponseDataType
    {
        $new = clone $this;
