...
class AttributeDescriptorType
{
    ...
    public function withStringValue(?string $stringValue): \Flexnet\LicenseService\Type\AttributeDescriptorType
    {
        $new = clone $this;
    ...
    public function withDateValue(?\DateTimeInterface $dateValue): \Flexnet\LicenseService\Type\AttributeDescriptorType
    {
        $new = clone $this;
    ...
    public function withBooleanValue(?bool $booleanValue): \Flexnet\LicenseService\Type\AttributeDescriptorType
    {
        $new = clone $this;
    ...
    public function withIntegerValue(?int $integerValue): \Flexnet\LicenseService\Type\AttributeDescriptorType
    {
        $new = clone $this;
