...
class ReturnShortCodeDataType
{
     ...
     * @return ReturnShortCodeDataType
     */
    public function withPublisherAttributes(\Flexnet\LicenseService\Type\PublisherAttributesListDataType|null $publisherAttributes) : \Flexnet\LicenseService\Type\ReturnShortCodeDataType
    {
        $new = clone $this;
     ...
     * @return ReturnShortCodeDataType
     */
    public function withOverridePolicy(bool|null $overridePolicy) : \Flexnet\LicenseService\Type\ReturnShortCodeDataType
    {
        $new = clone $this;
