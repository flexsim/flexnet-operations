...
class PublisherErrorFulfillmentResponseDataType
{
    ...
    /**
     * @param int $recordRefNo
     * @return PublisherErrorFulfillmentResponseDataType
     */
     ...
     * @return PublisherErrorFulfillmentResponseDataType
     */
    public function withFulfillment(\Flexnet\LicenseService\Type\FulfillmentDataType|null $fulfillment) : \Flexnet\LicenseService\Type\PublisherErrorFulfillmentResponseDataType
    {
        $new = clone $this;
