...
class CreatedChildLIFulfillmentInfoType
{
     ...
     * @return CreatedChildLIFulfillmentInfoType
     */
    public function withLicenseText(string|null $licenseText) : \Flexnet\LicenseService\Type\CreatedChildLIFulfillmentInfoType
    {
        $new = clone $this;
     ...
     * @return CreatedChildLIFulfillmentInfoType
     */
    public function withBinaryLicense(string|null $binaryLicense) : \Flexnet\LicenseService\Type\CreatedChildLIFulfillmentInfoType
    {
        $new = clone $this;
     ...
     * @return CreatedChildLIFulfillmentInfoType
     */
    public function withLicenseFiles(\Flexnet\LicenseService\Type\LicenseFileDataListType|null $licenseFiles) : \Flexnet\LicenseService\Type\CreatedChildLIFulfillmentInfoType
    {
        $new = clone $this;
