...
class EntitlementLineItemDataType
{
    ...
    public function withStartDateOption(?\Flexnet\EntitlementOrderService\Type\StartDateOptionType $startDateOption): \Flexnet\EntitlementOrderService\Type\EntitlementLineItemDataType
    {
        $new = clone $this;
    ...
    public function getLineItemType(): ?\Flexnet\EntitlementOrderService\Type\LineItemType
    {
        return $this->lineItemType;
    }

    public function withLineItemType(?\Flexnet\EntitlementOrderService\Type\LineItemType $lineItemType): \Flexnet\EntitlementOrderService\Type\EntitlementLineItemDataType
    {
        $new = clone $this;
    ...
    public function withState(?\Flexnet\EntitlementOrderService\Type\StateType $state): \Flexnet\EntitlementOrderService\Type\EntitlementLineItemDataType
    {
        $new = clone $this;
        $new->state = $state;
