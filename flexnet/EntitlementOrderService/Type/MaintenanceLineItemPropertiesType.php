...
class MaintenanceLineItemPropertiesType
{
    ...
    public function withState(?string $state): \Flexnet\EntitlementOrderService\Type\MaintenanceLineItemPropertiesType
    {
        $new = clone $this;
        $new->state = $state;
