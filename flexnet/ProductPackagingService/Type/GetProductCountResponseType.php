...
class GetProductCountResponseType implements ResultInterface
{
    /**
     ...
     * @param  \Flexnet\ProductPackagingService\Type\StatusInfoType  $statusInfo
     */
    public function withStatusInfo(StatusInfoType $statusInfo): GetProductCountResponseType
    {
        $new = clone $this;
     ...
     * @param  \Flexnet\ProductPackagingService\Type\GetCountResponseDataType|null  $responseData
     */
    public function withResponseData(GetCountResponseDataType|null $responseData): GetProductCountResponseType
    {
        $new = clone $this;
