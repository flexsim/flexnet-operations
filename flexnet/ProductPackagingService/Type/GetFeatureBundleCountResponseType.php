...
class GetFeatureBundleCountResponseType extends Result
{
     ...
     * @param  \Flexnet\ProductPackagingService\Type\StatusInfoType  $statusInfo
     */
    public function withStatusInfo(StatusInfoType $statusInfo): GetFeatureBundleCountResponseType
    {
        $new = clone $this;
     ...
     * @param  \Flexnet\ProductPackagingService\Type\GetCountResponseDataType|null  $responseData
     */
    public function withResponseData(GetCountResponseDataType|null $responseData): GetFeatureBundleCountResponseType
    {
        $new = clone $this;
