...
class GetFeatureBundleCountResponseType extends Result
{
    ...
    public function withStatusInfo(\Flexnet\ProductPackagingService\Type\StatusInfoType $statusInfo): \Flexnet\ProductPackagingService\Type\GetFeatureBundleCountResponseType
    {
        $new = clone $this;
    ...
    public function withResponseData(?\Flexnet\ProductPackagingService\Type\GetCountResponseDataType $responseData): \Flexnet\ProductPackagingService\Type\GetFeatureBundleCountResponseType
    {
        $new = clone $this;
