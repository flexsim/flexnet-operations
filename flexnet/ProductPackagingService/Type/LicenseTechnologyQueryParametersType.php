...
class LicenseTechnologyQueryParametersType
{
    ...
    public function withName(?\Flexnet\ProductPackagingService\Type\SimpleQueryType $name): \Flexnet\ProductPackagingService\Type\LicenseTechnologyQueryParametersType
    {
        $new = clone $this;
        $new->name = $name;
