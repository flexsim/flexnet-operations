...
class GetUniformSuiteCountResponseType implements ResultInterface
{
    /**
     ...
     * @param  \Flexnet\ProductPackagingService\Type\StatusInfoType  $statusInfo
     */
    public function withStatusInfo(StatusInfoType $statusInfo): GetUniformSuiteCountResponseType
    {
        $new = clone $this;
     ...
     * @param  \Flexnet\ProductPackagingService\Type\GetCountResponseDataType|null  $responseData
     */
    public function withResponseData(GetCountResponseDataType|null $responseData): GetUniformSuiteCountResponseType
    {
        $new = clone $this;
