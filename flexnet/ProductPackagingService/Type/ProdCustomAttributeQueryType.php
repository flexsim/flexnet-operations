...
class ProdCustomAttributeQueryType
{
    ...
    public function withAttributeName(string $attributeName): \Flexnet\ProductPackagingService\Type\ProdCustomAttributeQueryType
    {
        $new = clone $this;
    ...
    public function withStringValue(?\Flexnet\ProductPackagingService\Type\SimpleQueryType $stringValue): \Flexnet\ProductPackagingService\Type\ProdCustomAttributeQueryType
    {
        $new = clone $this;
