...
class GetDevicesResponseType extends FlexnetType implements ResultInterface
{
     ...
     */
    public function __construct(OpsEmbeddedStatusInfoType $statusInfo, FailedGetDevicesDataType $failedData = null, GetDevicesResponseDataType $responseData = null)
    {
     ...
     * @param  \Flexsim\FlexnetOperations\Type\GetDevicesResponseDataType  $responseData
     */
    public static function create(OpsEmbeddedStatusInfoType $statusInfo, FailedGetDevicesDataType $failedData = null, GetDevicesResponseDataType $responseData = null)
    {
