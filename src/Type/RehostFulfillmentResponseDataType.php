...
class RehostFulfillmentResponseDataType extends FlexnetType
{
     ...
     */
    public function __construct(int $recordRefNo, \Flexsim\FlexnetOperations\Type\FulfillmentDataType $fulfillment)
    {
     ...
     * @param \Flexsim\FlexnetOperations\Type\FulfillmentDataType $fulfillment
     */
    public static function create(int $recordRefNo, \Flexsim\FlexnetOperations\Type\FulfillmentDataType $fulfillment)
    {
