...
class GetFeatureBundleCountResponseType extends FlexnetType implements ResultInterface
{
     ...
     * @var \Flexsim\FlexnetOperations\Type\GetCountResponseDataType $responseData
     */
