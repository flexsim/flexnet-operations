...
class RestoreServedClientResponseType extends FlexnetType implements ResultInterface
{
     ...
     */
    public function __construct(OpsEmbeddedStatusInfoType $statusInfo, FailedRestoreServedClientDataType $failedData = null, RestoreServedClientDataType $responseData = null)
    {
     ...
     * @param  \Flexsim\FlexnetOperations\Type\RestoreServedClientDataType  $responseData
     */
    public static function create(OpsEmbeddedStatusInfoType $statusInfo, FailedRestoreServedClientDataType $failedData = null, RestoreServedClientDataType $responseData = null)
    {
