...
class GetUserPermissionsResponseType extends FlexnetType implements ResultInterface
{
     ...
     */
    public function __construct(StatusInfoType $statusInfo, GetUserPermissionsResponseDataType $responseData = null)
    {
     ...
     * @param  \Flexsim\FlexnetOperations\Type\GetUserPermissionsResponseDataType  $responseData
     */
    public static function create(StatusInfoType $statusInfo, GetUserPermissionsResponseDataType $responseData = null)
    {
