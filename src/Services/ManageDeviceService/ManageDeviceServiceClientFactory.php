...
use Flexsim\FlexnetOperations\Services\ManageDeviceService\ManageDeviceServiceClassmap;
...
{
    public static function factory(string $wsdl, string $username, string $password): \Flexsim\FlexnetOperations\Services\ManageDeviceService\ManageDeviceServiceClient
    {
