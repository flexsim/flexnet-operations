...
use Flexsim\FlexnetOperations\Services\LicenseService\LicenseServiceClassmap;
...
{
    public static function factory(string $wsdl, string $username, string $password): \Flexsim\FlexnetOperations\Services\LicenseService\LicenseServiceClient
    {
